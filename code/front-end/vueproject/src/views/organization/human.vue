...
<template>
  <div>
    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column sortable align="center" prop="username" label="用户名" width="120" show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="group" align="center" label="子组" width="120" show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="position" align="center" label="职位" width="120" show-overflow-tooltip>
      </el-table-column>      
      <el-table-column prop="capability" align="center" label="能力" width="120" show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="role" align="center" label="授权用户身份" width="120" show-overflow-tooltip>
      </el-table-column>             
