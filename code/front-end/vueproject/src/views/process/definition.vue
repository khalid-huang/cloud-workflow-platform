    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column align="center" prop="deployTime" label="部署时间" width="180">
        <template slot-scope="scope">
          <div>{{scope.row.deployTime|timestampToTime}}</div>
        </template>
      </el-table-column>
        ...
        data: [
          {
            addUser: null,
            editUser: null,
            id: 'design_department_leave:1:295028',
            name: 'leave process',
            key: 'design_department_leave',
            deployTime: 1553420989000,
          },
          {
            addUser: null,
            editUser: null,
            id: 'a6-model:1:295016',
            name: '6-model',
            key: 'a6-model',
            deployTime: 1553419632000,
          }
        ]
      }
      this.loading = false
