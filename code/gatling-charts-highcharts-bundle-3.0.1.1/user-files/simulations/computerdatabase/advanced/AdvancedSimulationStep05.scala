...
class AdvancedSimulationStep05 extends Simulation {
  ...
  setUp(
    users.inject(rampUsers(20) during (10 seconds)).throttle(reachRps(5) in (5 seconds), holdFor(30 seconds)),
    admins.inject(rampUsers(30) during (10 seconds)).throttle(reachRps(4) in (5 seconds), holdFor(20 seconds)),
