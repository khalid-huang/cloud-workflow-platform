...
//@Component
public class MultiTenantConnectionProviderImpl_UP implements MultiTenantConnectionProvider {
    @Autowired
    ...
    public Connection getConnection(String tenantIdentifier) throws SQLException {
        ...
        try {
            ...
            throw new HibernateException(
                    "Could not alter JDBC connection to specified schema [" + tenantIdentifier + "]" + " " + e.toString(),
                    e
            );
        }
        return connection;
