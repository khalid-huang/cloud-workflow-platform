package org.sysu.apigatewayservice.util;

import io.jsonwebtoken.*;
import org.sysu.apigatewayservice.constant.ResponseCode;
...
public class JWTUtils {
     ...
     * @return JWTResult
     */
    public static JWTResult checkToken(String token, String secreteKey) {
        try {
